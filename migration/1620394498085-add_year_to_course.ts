...
export class addYearToCourse1620394498085 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "course" DROP COLUMN "departmentsId"`);
        await queryRunner.query(`ALTER TABLE "departments" ADD "coursesId" uuid`);
        await queryRunner.query(`ALTER TABLE "course" ADD "year" integer NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "course" DROP COLUMN "departmentId"`);
        await queryRunner.query(`ALTER TABLE "course" DROP COLUMN "year"`);
        await queryRunner.query(`ALTER TABLE "departments" DROP COLUMN "coursesId"`);
        await queryRunner.query(`ALTER TABLE "course" ADD "departmentsId" uuid`);
