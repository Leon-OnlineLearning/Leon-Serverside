...
export class DatabaseInit1619053257933 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "student_lecture_attendance" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "studentId" uuid, "lectureId" uuid, CONSTRAINT "PK_b194974eb031906ca0a944ee331" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "report" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "startingFrom" TIMESTAMP NOT NULL, "endingAt" TIMESTAMP NOT NULL, "result" character varying(1) NOT NULL, "studentId" uuid, "examId" uuid, CONSTRAINT "PK_99e4d0bea58cba73c57f935a546" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "embedding" ("vector" numeric(9) array NOT NULL, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), CONSTRAINT "PK_9457e810efc9c802fe5047347d6" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "students_exams" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "mark" integer NOT NULL, "studentId" uuid, "examId" uuid, CONSTRAINT "PK_0920130b8f0d92b00accff50e75" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "exam" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying NOT NULL, "year" integer NOT NULL, "startTime" TIMESTAMP NOT NULL, "endTime" TIMESTAMP NOT NULL, "mark" integer NOT NULL, "courseId" uuid, "professorId" uuid, CONSTRAINT "PK_56071ab3a94aeac01f1b5ab74aa" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "departments" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "lecturesId" uuid, "examsId" uuid, CONSTRAINT "PK_839517a681a86bb84cbcc6a1e9d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "course" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "departmentsId" uuid, CONSTRAINT "PK_bf95180dd756fd204fb01ce4916" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "professor_courses_course" ("professorId" uuid NOT NULL, "courseId" uuid NOT NULL, CONSTRAINT "PK_0f9c01ffaf4f1c5c1737fe26c5f" PRIMARY KEY ("professorId", "courseId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_d8e718fbdea73702563e6cfecb" ON "professor_courses_course" ("professorId") `);
        await queryRunner.query(`CREATE INDEX "IDX_6eb199629534b22f498dec9567" ON "professor_courses_course" ("courseId") `);
        ...
        await queryRunner.query(`CREATE TABLE "DEPARTMENT_COURSES" ("departmentsId" uuid NOT NULL, "courseId" uuid NOT NULL, CONSTRAINT "PK_9eeae6f5b243ea9d87166a42a28" PRIMARY KEY ("departmentsId", "courseId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_e6c478cfd1402822df7b5e2568" ON "DEPARTMENT_COURSES" ("departmentsId") `);
        await queryRunner.query(`CREATE INDEX "IDX_965801c63747a7f8dc0570e6e4" ON "DEPARTMENT_COURSES" ("courseId") `);
        ...
        await queryRunner.query(`ALTER TABLE "report" ADD CONSTRAINT "FK_43eef8080ece60ccb041dd31809" FOREIGN KEY ("studentId") REFERENCES "student"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "report" ADD CONSTRAINT "FK_43ee63268434d93f7896a50f308" FOREIGN KEY ("examId") REFERENCES "exam"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "professor_courses_course" ADD CONSTRAINT "FK_d8e718fbdea73702563e6cfecb2" FOREIGN KEY ("professorId") REFERENCES "professor"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "professor_courses_course" ADD CONSTRAINT "FK_6eb199629534b22f498dec9567e" FOREIGN KEY ("courseId") REFERENCES "course"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "DEPARTMENT_COURSES" ADD CONSTRAINT "FK_e6c478cfd1402822df7b5e25689" FOREIGN KEY ("departmentsId") REFERENCES "departments"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "DEPARTMENT_COURSES" ADD CONSTRAINT "FK_965801c63747a7f8dc0570e6e49" FOREIGN KEY ("courseId") REFERENCES "course"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "DEPARTMENT_COURSES" DROP CONSTRAINT "FK_965801c63747a7f8dc0570e6e49"`);
        await queryRunner.query(`ALTER TABLE "DEPARTMENT_COURSES" DROP CONSTRAINT "FK_e6c478cfd1402822df7b5e25689"`);
        ...
        await queryRunner.query(`ALTER TABLE "professor_courses_course" DROP CONSTRAINT "FK_6eb199629534b22f498dec9567e"`);
        await queryRunner.query(`ALTER TABLE "professor_courses_course" DROP CONSTRAINT "FK_d8e718fbdea73702563e6cfecb2"`);
        await queryRunner.query(`ALTER TABLE "course" DROP CONSTRAINT "FK_254eaf1f4ac5c87bd1ebc2efce3"`);
        await queryRunner.query(`ALTER TABLE "departments" DROP CONSTRAINT "FK_334b23b781f57a4113bd0eef86d"`);
        await queryRunner.query(`ALTER TABLE "departments" DROP CONSTRAINT "FK_16d3333406d0e7b64b95d51d22e"`);
        await queryRunner.query(`ALTER TABLE "exam" DROP CONSTRAINT "FK_d13e02e30e86bbf25e5e3e7bee8"`);
        await queryRunner.query(`ALTER TABLE "exam" DROP CONSTRAINT "FK_e6b0d68b26f7847f2d46810df8f"`);
        await queryRunner.query(`ALTER TABLE "students_exams" DROP CONSTRAINT "FK_0c9ec9dd610ce25a3896ab580e0"`);
        await queryRunner.query(`ALTER TABLE "students_exams" DROP CONSTRAINT "FK_ae4d89d9a5da2b3d43a65ae0b07"`);
        await queryRunner.query(`ALTER TABLE "student" DROP CONSTRAINT "FK_e37af156fe109a0c491a40afe29"`);
        await queryRunner.query(`ALTER TABLE "student" DROP CONSTRAINT "FK_5055e57181dc1d5ff6f4da7a98c"`);
        await queryRunner.query(`ALTER TABLE "report" DROP CONSTRAINT "FK_43ee63268434d93f7896a50f308"`);
        await queryRunner.query(`ALTER TABLE "report" DROP CONSTRAINT "FK_43eef8080ece60ccb041dd31809"`);
        await queryRunner.query(`ALTER TABLE "student_lecture_attendance" DROP CONSTRAINT "FK_52753ba2926a7e545d9827ba873"`);
        await queryRunner.query(`ALTER TABLE "student_lecture_attendance" DROP CONSTRAINT "FK_e78ee3aed41d963a3a9fd4079c2"`);
        await queryRunner.query(`ALTER TABLE "lecture" DROP CONSTRAINT "FK_137552ffd78c2368c74ccf19de6"`);
        await queryRunner.query(`ALTER TABLE "lecture" DROP CONSTRAINT "FK_89e61e55d5b02ea76363a3a55a6"`);
        await queryRunner.query(`ALTER TABLE "professor" DROP CONSTRAINT "FK_7e281a085f2314de20f6a62fe41"`);
